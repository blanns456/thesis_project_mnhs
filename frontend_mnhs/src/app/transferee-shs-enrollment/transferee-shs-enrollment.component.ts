...
import { TransfereeSHSControllers } from '../controllers/transfereeshsController.component';
...
export class TransfereeShsEnrollmentComponent implements OnInit {
  ...
  constructor(
    ...
    private TransfereeSHSControllers: TransfereeSHSControllers,
  ...
  savestudent() {
    ...
    this.TransfereeSHSControllers.createtransfereeSHS(submitdata).subscribe(
      (e) => {
        this.studata = e;
